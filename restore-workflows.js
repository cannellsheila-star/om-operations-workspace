  ...
  renderTickets = function renderTicketsRestored() {
    ...
    appView.innerHTML = `
      ...
      <div class="ticket-list">${rows || `<section class="surface" style="display:flex;align-items:center;justify-content:space-between;gap:24px;margin:0;border:0;">
        <div><p class="eyebrow">TICKETS</p><h3 style="margin:5px 0 7px;">No open tickets</h3><p class="muted" style="margin:0;max-width:660px;">Create a ticket from monitoring, maintenance, an on-site issue or asset review. It opens the full workroom with a log, attachments, dedicated email and PM routing.</p></div>
